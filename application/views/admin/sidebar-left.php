        ...
        <div class="sidebar-content">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-header">
                    ...
                    <span class="sidebar-header-title"><?php echo $this->lang->line('languageTitle'); ?></span>
                </li>
                <li>
                    <a href="#" class="sidebar-nav-menu"><i class="fa fa-angle-left sidebar-nav-indicator sidebar-nav-mini-hide"></i><i class="gi gi-certificate sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide"><?php echo $this->lang->line('languageTitle'); ?></span></a>
                    <ul>
                        <li>
                            <a href="<?php echo site_url(); ?>admin/setLang/tr"><i class="gi gi-leaf sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">Türkçe</span></a>
                        </li>
                        <li>
                            <a href="<?php echo site_url(); ?>admin/setLang/en"><i class="gi gi-leaf sidebar-nav-icon"></i><span class="sidebar-nav-mini-hide">English</span></a>
                        </li>
                    </ul>
                </li>
            </ul>
